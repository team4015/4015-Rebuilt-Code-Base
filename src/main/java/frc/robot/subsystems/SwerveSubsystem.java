...
public class SwerveSubsystem extends SubsystemBase {
    ...
    public Command driveCommand(DoubleSupplier translationX, DoubleSupplier translationY,
        ...
        return run(() -> {
            ...
            boolean button1Pressed = driverCtrl.getHID().getRawButton(1);
            boolean button2Pressed = driverCtrl.getHID().getRawButton(2);
            boolean button3Pressed = driverCtrl.getHID().getRawButton(3);
            boolean button4Pressed = driverCtrl.getHID().getRawButton(4);
            ...
            SmartDashboard.putBoolean("Button1Pressed", button1Pressed);
            SmartDashboard.putBoolean("Button2Pressed", button2Pressed);
            SmartDashboard.putBoolean("Button3Pressed", button3Pressed);            
            SmartDashboard.putBoolean("Button4Pressed", button4Pressed);
